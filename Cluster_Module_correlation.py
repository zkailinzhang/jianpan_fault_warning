...
class ClusterModulelr:
    def __init__(self,config,system_id,kks,interval,start_row,end_row,table):
    ...
    def run(self):
        ...
        if self.kks_correlation:
            ...
            try:
                for i in correlation_dict.keys():
                    print(i)
                    load_data = self.hbase.get_data(self.conf.hbase_table, self.start_row, self.end_row, i)
                    ...
                    for kks in kks_name:
                        print('1:', kks)
                        # data = load_data[kks]
                        data = self.hbase.get_data(self.conf.hbase_table, self.start_row, self.end_row, kks)
            ...
            if data_dict:
                ...
                if cluster_result:
                    #self.mysql.delete(self.table, self.system_id)
                    for i in fit_value.keys():
                        ...
                        #self.mysql.insert_data(self.table, self.conf.mysql_sentence, value)
